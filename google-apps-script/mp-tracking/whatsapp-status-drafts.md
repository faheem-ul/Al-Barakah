...
Shared footer (every message) + closing line:
...
Delivered review link: `https://g.page/r/Cb5ju-Dzbs1nEBM/review`
...
## 2. Arrived at OPS Facility

```
Hi {{Customer Name}}! 🍯

Your order #{{Order Number}} has reached the M&P facility and is now being processed for transit.
...
Good news! Your order #{{Order Number}} is now on its way. 🚚
...
## 4. Reached at Destination

```
Hi {{Customer Name}}! 🍯

Your order #{{Order Number}} has reached your city. 📍
...
Your Al Barakah Honey order #{{Order Number}} is out for delivery today! 🚚🎉
...
Your Al Barakah Honey order #{{Order Number}} has been successfully delivered. 🎉
...
## 7. Unsuccessful Delivery Attempt

```
Hi {{Customer Name}}! 🍯

M&P was unable to deliver your order #{{Order Number}} today.
...
Your order #{{Order Number}} is currently on hold with M&P after an unsuccessful delivery attempt.
...
Good news! M&P has scheduled another delivery attempt for your order #{{Order Number}}. 🚚
...
Unfortunately, M&P could not complete the delivery of your order #{{Order Number}}.
...
Your order #{{Order Number}} is currently being returned to us by M&P.
...
## 12. Return – Reached at Origin

```
Hi {{Customer Name}}! 🍯

Your order #{{Order Number}} has reached the origin location during the return process.
...
## 13. Return – Out for Delivery

```
Hi {{Customer Name}}! 🍯

Your parcel #{{Order Number}} is now out for delivery back to us as part of the return process.
...
## 14. Return to Vendor / Return to Shipper

```
Hi {{Customer Name}}! 🍯

Your order #{{Order Number}} has been returned to us by M&P.
