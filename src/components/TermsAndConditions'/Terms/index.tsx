      ...
      <div className="space-y-6">
        <div>
          ...
          <Text className="mb-4 font-poppins font-normal text-[18px] leading-[30px] ">
            ...
            conditions. Do not continue to use Al Barakah Honey if you do not
        ...
        <div>
          ...
          <Text className="mb-4 font-poppins font-normal text-[18px] leading-[30px] ">
            We employ the use of cookies. By accessing Al Barakah Honey, you
            agreed to use cookies in agreement with the Al Barakah {`Honey's`}
            Privacy Policy.
          </Text>
          <Text className="font-poppins font-normal text-[18px] leading-[30px] ">
        ...
        <div>
          ...
          <Text className="mb-4 font-poppins font-normal text-[18px] leading-[30px] ">
            Unless otherwise stated, Al Barakah Honey and/or its licensors own
            the intellectual property rights for all material on Al Barakah
            Honey. All intellectual property rights are reserved. You may access
            this from Al Barakah Honey for your own personal use subjected to
          ...
          <ul className="list-disc list-inside ml-4 mb-4">
            <li>Republish material from Al Barakah Honey</li>
            <li>Sell, rent or sub-license material from Al Barakah Honey</li>
            <li>Reproduce, duplicate or copy material from Al Barakah Honey</li>
            <li>Redistribute content from Al Barakah Honey</li>
          </ul>
          <Text className="mb-4 font-poppins font-normal text-[18px] leading-[30px] ">
          ...
          <Text className="mb-4 font-poppins font-normal text-[18px] leading-[30px] ">
            ...
            Al Barakah Honey does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of Al Barakah Honey,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their
            views and opinions. To the extent permitted by applicable laws, Al
            Barakah Honey shall not be liable for the Comments or for any
          ...
          <Text className="mb-4 font-poppins font-normal text-[18px] leading-[30px] ">
            Al Barakah Honey reserves the right to monitor all Comments and to
          ...
          <Text className="font-poppins font-normal text-[18px] leading-[30px] ">
            You hereby grant Al Barakah Honey a non-exclusive license to use,
        ...
        <div>
          ...
          <Text className="mb-4 font-poppins font-normal text-[18px] leading-[30px] ">
            ...
            visibility of the hyperlink compensates the absence of Al Barakah
            Honey; and (d) the link is in the context of general resource
            information.
          </Text>
          <Text className="mb-4 font-poppins font-normal text-[18px] leading-[30px] ">
          ...
          <Text className="mb-4 font-poppins font-normal text-[18px] leading-[30px] ">
            ...
            sending an e-mail to Al Barakah Honey. Please include your name,
          ...
          <Text className="font-poppins font-normal text-[18px] leading-[30px] ">
            No use of Al Barakah {`Honey's`} logo or other artwork will be
