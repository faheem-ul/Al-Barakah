    ...
    <div className="max-w-[1117px] mx-auto px-6 mt-[50px] py-8">
      <div className="space-y-6">
        ...
        <div>
          ...
          <h3 className="mb-3 font-poppins font-bold text-[24px] leading-[30px]">
            Interpretation
          </h3>
          <Text className="mb-4 font-poppins font-normal text-[18px] leading-[30px]">
          ...
          <ul className="list-disc list-inside ml-4 mb-4 space-y-2">
            ...
            <li>
              ...
              {`"the Company",
              "We", "Us" or "Our"`}{" "}
              in this Agreement) refers to albaraka honey.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to albaraka honey, accessible from
              https://albarakahoney.com/
            </li>
            <li>
        ...
        <div>
          ...
          <h4 className="mb-2 font-poppins font-semibold text-[20px] leading-[30px]">
            Personal Data
          </h4>
          <Text className="mb-4 font-poppins font-normal text-[18px] leading-[30px]">
        ...
        <div>
          ...
          <div className="ml-4 mb-4 space-y-4">
            <div>
              <Text className="font-poppins font-semibold text-[18px] leading-[30px]">
